...
function consultaProcessosDescontosAtivos(funcionario) {
  ...
  constraints.push(DatasetFactory.createConstraint('rdTipoDesconto', 'dp', 'dp', ConstraintType.MUST_NOT)); // DESCONSIDERAR PROCESSOS DO TIPO DP
  constraints.push(DatasetFactory.createConstraint('atividadeAtual', '27', '27', ConstraintType.MUST_NOT)); // FIM APROVA ABONA
  constraints.push(DatasetFactory.createConstraint('atividadeAtual', '10', '10', ConstraintType.MUST_NOT)); // FIM INTEGRAÇÃO OK
  constraints.push(DatasetFactory.createConstraint('atividadeAtual', '00', '00', ConstraintType.MUST_NOT)); // INÍCIO
