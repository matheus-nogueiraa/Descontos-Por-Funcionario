...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="https://fluig.elcop.eng.br:8443/style-guide/css/fluig-style-guide.min.css"
    />
    <link
      rel="stylesheet"
      href="../webapp/resources/css/wgd_consulta_lancamentos_descontos_funcionario.css"
    />
    ...
    ></script>
    <script
      src="//cdn.datatables.net/buttons/2.1.0/js/dataTables.buttons.min.js"
      charset="utf-8"
    ></script>
    <link
      rel="stylesheet"
    ...
    <link
      rel="stylesheet"
      href="//cdn.datatables.net/buttons/2.1.0/css/buttons.dataTables.min.css"
    />
    <script
    ...
    ></script>
    <script
      src="//cdn.datatables.net/buttons/2.1.0/js/buttons.html5.min.js"
      charset="utf-8"
    ></script>
    <script
      src="//cdn.datatables.net/buttons/2.1.0/js/buttons.print.min.js"
      charset="utf-8"
    ></script>
  ...
  >
    <div class="card">
      <div class="card-body">
        <div class="row">
          <div
            class="form-group col-md-6 css_header_img"
            style="margin-left: 1rem"
          >
            <img
              src="/wgd_consulta_lancamentos_descontos/resources/images/elcop_nossa_energia.png"
              alt="Logo Elcop"
              width="329"
              height="194"
            />
            <label class="css_header_text"
              >Consulta Lançamentos de Descontos</label
            >
          </div>
        </div>
      </div>
        ...
        <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="form-group col-md-4">
              ...
              <select
                name="statusAtualProcesso"
                id="statusAtualProcesso"
                class="form-control"
              >
        ...
        -->
          ...
          <div class="row">
            <div class="form-group col-md-12">
              <button
                class="btn btn-success widthFull"
                onclick="loadTable()"
                id="filterButton"
              >
                Consultar Descontos
