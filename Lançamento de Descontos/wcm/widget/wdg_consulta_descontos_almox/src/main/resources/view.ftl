    ...
    <div class="card-body">
      <div class="row">
        <div class="form-group col-md-6 css_header_img" style="margin-left: 1rem;">
          <img src="/wdg_consulta_descontos_almox/resources/images/elcop_nossa_energia.png" alt="Logo Elcop"
            width="329" height="194">
          <label class="css_header_text">Consulta Lançamentos de Descontos - Almoxarifado</label>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="form-group col-md-2">
            ...
            <input type="date" name="dataDe" id="dataDe" class="form-control">
          </div>
          <div class="form-group col-md-2">
            <label for="dataAte">Data até: </label>
            <input type="date" name="dataAte" id="dataAte" class="form-control">
          </div>
          <div class="form-group col-md-3">
            <label for="matriculaFiltro">Selecione o Funcionário: </label>
            <input type="text" name="matriculaFiltro" id="matriculaFiltro" class="form-control">
            <small>* Digite nome, matrícula ou filial para localizar o funcionário.</small>
          </div>
          <div class="form-group col-md-3">
