    ...
    <div class="card-body">
      <div class="row">
        <div class="form-group col-md-6 css_header_img" style="margin-left: 1rem;">
          <img src="/wgd_consulta_descontos_frotas/resources/images/elcop_nossa_energia.png" alt="Logo Elcop"
            width="329" height="194">
          <label class="css_header_text">Consulta Lançamentos de Descontos - FROTAS</label>
        </div>
      </div>
    </div>
  </div>
